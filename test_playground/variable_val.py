...
class VariableValTest(Slide):
    def construct(self):
        variable_val = VariableVal(UP * 3, "x", "", "5", "", rhs_prt1_color=RED)
        self.play(Write(variable_val.mobject), run_time=1)

        self.play(Indicate(VGroup(variable_val.mobject[0].submobjects[slice(*variable_val.get_lhs_prt1_range())]).set_color(variable_val.lhs_prt1_color)))
        ...
        variable_val = variable_val.transform_object # Cursed as fuck
